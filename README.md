...
*   **Frontend & Backend (Full-Stack)**: [Next.js](https://nextjs.org/) (App Router, Server Components + Client Components).
...
*   **Icons**: `lucide-react`.
*   **Database**: [Prisma ORM](https://www.prisma.io/) supporting dual databases:
